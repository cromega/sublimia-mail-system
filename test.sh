...
# SMTP AUTH
sqlite3 /etc/postfix/mail.db 'INSERT INTO mailboxes VALUES ("test@test.com", "{SHA256}n4bQgYhMfWWaL+qgxVrQFaO/TxsrC4Is0V1sFbDwCgg=", "test.com/test", CURRENT_TIMESTAMP, 5000, 5000);'
